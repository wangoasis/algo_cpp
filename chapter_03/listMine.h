...
public:
/*
  the only difference between const_iterator and iterator is that:
  *(const_iterator) returns to a const object that cannot be modified
  while *(iterator) returns to a object that can be modified
  You must use const_iterator to go through a list or set,(just like for loop),
  when you don't want to change the item in the list.
*/
